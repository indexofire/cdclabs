...
from archive.utils import get_profile_model, get_profile_form
...
class ProfileBase(models.Model):
    """
    The base models for custom profiles
    """
    ...
    def get_absolute_url(self, group=None):
        if MULTIPLE_PROFILES:
            ...
            kwargs = {'profile_slug': self.profile_slug, 'profile_pk': self.pk,}
        else:
