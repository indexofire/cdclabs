...
urlpatterns = patterns('apps.group.views.groups',
...
# Topics
urlpatterns += patterns('apps.group.views.topics',
...
# Pages
urlpatterns += patterns('apps.group.views.pages',
...
# Messages
urlpatterns += patterns('apps.group.views.messages',
